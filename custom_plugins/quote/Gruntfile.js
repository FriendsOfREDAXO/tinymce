...
module.exports = (grunt) => {
  ...
  grunt.initConfig({
    ...
    copy: {
      css: {
        files: [
          { src: [ 'CHANGELOG.txt', 'LICENSE.txt' ], dest: 'dist/quote', expand: true }
        ]
      }
    },
  ...
  grunt.registerTask('version', 'Creates a version file', () => {
    grunt.file.write('dist/quote/version.txt', BUILD_VERSION);
  });
