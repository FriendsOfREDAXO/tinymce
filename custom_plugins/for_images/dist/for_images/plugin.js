(()=>{var G=[{label:"Original",class:""},{label:"Klein (150px)",class:"img-width-small"},{label:"Mittel (300px)",class:"img-width-medium"},{label:"Gro\xDF (600px)",class:"img-width-large"},{label:"100%",class:"img-width-full"}],j=[{label:"Keine",class:""},{label:"Links",class:"img-align-left"},{label:"Rechts",class:"img-align-right"},{label:"Zentriert",class:"img-align-center"}],q=[{label:"Kein Effekt",class:""}],I=class{constructor(n){this.cache=null;this.editor=n}get(){if(this.cache)return this.cache;let n=g=>{var r,f,h;let c=this.editor.options.get(g);return(!c||Array.isArray(c)&&c.length===0)&&(c=(r=this.editor.settings)==null?void 0:r[g]),(!c||Array.isArray(c)&&c.length===0)&&(c=(h=(f=this.editor).getParam)==null?void 0:h.call(f,g,null)),c},l=(g,c)=>Array.isArray(g)&&g.length>0?g:c;return this.cache={widthPresets:l(n("imagewidth_presets"),G),alignPresets:l(n("imagealign_presets"),j),effectPresets:l(n("imageeffect_presets"),q)},this.cache}invalidate(){this.cache=null}getAllClasses(n){let l=[];return n.forEach(g=>{g.class&&g.class.split(/\s+/).forEach(c=>{c&&!l.includes(c)&&l.push(c)})}),l}};function b(e){if(e.nodeName==="FIGURE")return e;let n=e.parentElement;return n&&n.nodeName==="FIGURE"?n:null}function _(e,n){let l=b(n);if(l)return l;let c=e.getDoc().createElement("figure"),r=n.parentElement;return r&&r.nodeName==="P"?Array.from(r.childNodes).some(h=>h!==n&&(h.nodeType!==Node.TEXT_NODE||(h.textContent||"").trim()!==""))?(r.parentNode.insertBefore(c,r),c.appendChild(n)):(r.parentNode.insertBefore(c,r),c.appendChild(n),r.remove()):r&&(r.insertBefore(c,n),c.appendChild(n)),c}function p(e){let n=e.selection.getNode();if(n.nodeName==="IMG")return n;if(n.nodeName==="FIGURE")return n.querySelector("img");if(n.nodeName==="FIGCAPTION"){let l=n.parentElement;if((l==null?void 0:l.nodeName)==="FIGURE")return l.querySelector("img")}return null}function D(e,n){let l=n!=null?n:e.getBody();if(!l)return;Array.from(l.querySelectorAll("img")).filter(r=>{let f=r.parentElement;return!(f&&f.nodeName==="FIGURE")}).forEach(r=>{_(e,r)}),Array.from(l.querySelectorAll("figure")).forEach(r=>{r.querySelector("img")||r.remove()})}function H(e,n,l){if(n.forEach(g=>e.classList.remove(g)),l){let g=[];e.classList.forEach(r=>{(r==="image"||r==="image_resized"||r.startsWith("image-style-")||r.startsWith("img-width-")||r.startsWith("img-height-"))&&g.push(r)}),g.forEach(r=>e.classList.remove(r));let c=e.style.width;c&&c.includes("%")&&(e.style.removeProperty("width"),e.getAttribute("style")===""&&e.removeAttribute("style"))}}function L(e,n){A(n).forEach(g=>e.classList.remove(g))}function A(e){let n=[];return e.forEach(l=>{l.class&&l.class.split(/\s+/).forEach(g=>{g&&!n.includes(g)&&n.push(g)})}),n}function z(e){let n=A(e).join(" ");return n.includes("uk-width")?"uk-width-1-1":/\bw-\d/.test(n)?"w-100":""}function R(e,n){e.classList.remove("uk-width-1-1","w-100"),e.style.removeProperty("width"),n?e.classList.add(n):e.style.width="100%"}function U(e,n,l,g,c=!1){let r=l.class?_(e,n):b(n),f=z(g),h=A(g);r&&(H(r,h,c),l.class?(l.class.split(/\s+/).forEach(d=>{d&&r.classList.add(d)}),R(n,f)):f&&(f.split(/\s+/).forEach(d=>{d&&n.classList.remove(d)}),n.classList.length===0&&n.removeAttribute("class")),r.classList.length===0&&r.removeAttribute("class")),n.style.removeProperty("width"),n.style.removeProperty("height"),n.getAttribute("style")===""&&n.removeAttribute("style"),e.nodeChanged(),e.undoManager.add()}function W(e,n,l,g,c=!1){if(l.class){let r=_(e,n),f=l.class.split(/\s+/).filter(d=>d);f.every(d=>r.classList.contains(d))?f.forEach(d=>r.classList.remove(d)):f.forEach(d=>r.classList.add(d)),c&&H(r,A(g),!0),r.classList.length===0&&r.removeAttribute("class")}else{let r=b(n);r&&(H(r,A(g),c),r.classList.length===0&&r.removeAttribute("class"))}e.nodeChanged(),e.undoManager.add()}function x(e,n,l,g){U(e,n,l,g,!!e.options.get("image_compat_warn"))}function K(e,n,l,g){W(e,n,l,g,!!e.options.get("image_compat_warn"))}function w(e,n){let g=b(e)||e;for(let c of n){if(!c.class)continue;let r=c.class.split(/\s+/).filter(f=>f);if(r.length>0&&r.every(f=>g.classList.contains(f)))return c}return null}function T(e,n){let g=b(e)||e,c=[];for(let r of n){if(!r.class)continue;let f=r.class.split(/\s+/).filter(h=>h);f.length>0&&f.every(h=>g.classList.contains(h))&&c.push(r)}return c}var X=`
  figure {
    margin: 0;
    padding: 0;
    display: table;
