...
`;function y(e,r,i){e.windowManager.open({title:"Video einbetten (YouTube / Vimeo)",body:{type:"panel",items:[{type:"input",name:"url",label:"URL",placeholder:"https://www.youtube.com/watch?v=\u2026  oder  https://vimeo.com/\u2026"},{type:"htmlpanel",html:'<p style="color:#888;font-size:12px;margin:4px 0 0;">Unterst\xFCtzt: YouTube, YouTube Shorts, youtu.be, Vimeo. Das Video wird im CKE5-kompatiblen <code>&lt;oembed&gt;</code>-Format gespeichert.</p>'}]},initialData:{url:r},buttons:[{type:"cancel",text:"Abbrechen"},{type:"submit",text:"\xDCbernehmen",primary:!0}],onSubmit:n=>{let a=(n.getData().url||"").toString().trim();if(!b(a)){e.windowManager.alert("Die URL wird nicht unterst\xFCtzt. Es werden YouTube- und Vimeo-URLs erkannt.");return}i(a),n.close()}})}function f(e,r){let i=r||e.selection.getNode();return e.dom.getParent(i,"figure.for-oembed")}function $(e,r){let i=b(r);if(!i)return;let n=[];i.suggestedRatio&&P[i.suggestedRatio]&&n.push(P[i.suggestedRatio]),e.undoManager.transact(()=>{e.insertContent(v(i,n)+"<p>&nbsp;</p>")}),e.nodeChanged()}function E(e,r,i){let n=b(i);if(!n)return;let s=w(r),a=document.createElement("div");a.innerHTML=v(n,s);let c=a.firstElementChild;c&&(e.undoManager.transact(()=>{var t;(t=r.parentNode)==null||t.replaceChild(c,r)}),e.nodeChanged())}function U(e,r){let i=r.getAttribute("data-for-oembed-url")||"",n=b(i);if(!n)return;let s=r.querySelector(".for-oembed__ratio");if(!s)return;s.removeAttribute("style"),s.innerHTML="";let a=document.createElement("iframe");a.src=n.embedSrc+(n.embedSrc.indexOf("?")>=0?"&":"?")+"autoplay=1",a.setAttribute("allow",n.allow),a.setAttribute("allowfullscreen",""),a.setAttribute("frameborder","0"),a.setAttribute("referrerpolicy","strict-origin-when-cross-origin"),s.appendChild(a),r.setAttribute("data-for-oembed-active","1"),e.nodeChanged()}function N(e,r){var t;let i=r.getAttribute("data-for-oembed-url")||"",n=b(i);if(!n)return;let s=w(r),a=document.createElement("div");a.innerHTML=v(n,s);let c=a.firstElementChild;c&&((t=r.parentNode)==null||t.replaceChild(c,r),e.nodeChanged())}function A(e,r,i,n){e.undoManager.transact(()=>{i.forEach(s=>{s&&r.classList.remove(s)}),n&&r.classList.add(n)}),e.nodeChanged()}function T(e,r){if(!e)return"";for(let i of r)if(i.value&&e.classList.contains(i.value))return i.value;return""}function F(e){let r=(e||"").trim();return!r||/\s/.test(r)&&r.split(/\s+/).length>1||!/^https?:\/\//i.test(r)?null:b(r)?r:null}var q=()=>{tinymce.PluginManager.add("for_oembed",e=>{try{e.options.set("sandbox_iframes",!1),e.options.set("convert_unsafe_embeds",!1),e.options.set("xss_sanitization",!1)}catch(t){}e.on("PreInit",()=>{let t=e.schema;try{t.addValidChildren("+figure[oembed|div|iframe]"),t.addValidChildren("+div[iframe|div|svg|img|span|button]"),t.addValidChildren("+button[svg]"),t.addValidChildren("+svg[path|rect|g]")}catch(o){}}),e.on("init",()=>{try{e.dom.addStyle(I)}catch(t){}try{L(e.getBody())}catch(t){}}),e.on("SetContent",()=>{try{L(e.getBody())}catch(t){}}),e.on("GetContent",t=>{t&&typeof t.content=="string"&&(t.content=O(t.content))}),e.on("PreProcess",t=>{let o=t&&t.node;if(!o||typeof o.getAll!="function")return;o.getAll("figure").forEach(l=>{let u=l.attr("class")||"";if(u.indexOf("for-oembed")===-1)return;let h=l.attr("data-for-oembed-url")||"";if(!h){l.remove();return}let V=u.split(/\s+/).filter(p=>p&&p!=="media"&&S.indexOf(p)===-1),z=H(h,V),x=tinymce.html.DomParser?new tinymce.html.DomParser({validate:!1}).parse(z):null;if(x&&x.firstChild){let p=l.firstChild;for(;p;){let g=p.next;l.remove(p),p=g}let M=x.firstChild;(l.attributes?l.attributes.slice():[]).forEach(g=>l.attr(g.name,null)),(M.attributes||[]).forEach(g=>l.attr(g.name,g.value));let _=M.firstChild;for(;_;){let g=_.next;l.append(_),_=g}}})}),e.on("PastePreProcess",t=>{if(!t||typeof t.content!="string")return;let o=t.content.replace(/<[^>]*>/g,"").trim(),d=F(o);if(!d)return;let l=b(d);l&&(t.content=v(l))}),e.on("click",t=>{let o=t.target;if(!o||!o.closest)return;let d=f(e,o);if(d){if(o.closest("[data-for-oembed-stop]")){t.preventDefault(),t.stopPropagation(),N(e,d);let l=f(e);l&&e.selection.select(l);return}if(o.closest("[data-for-oembed-select]")||o.closest(".for-oembed__url")){t.preventDefault(),t.stopPropagation(),e.selection.select(d),e.nodeChanged();return}if(o.closest(".for-oembed__toolbar")){t.preventDefault(),t.stopPropagation(),e.selection.select(d),e.nodeChanged();return}if(o.closest(".for-oembed__play")||o.closest(".for-oembed__ratio")){if(d.getAttribute("data-for-oembed-active")==="1")return;t.preventDefault(),t.stopPropagation(),U(e,d)}}}),e.on("dblclick",t=>{let o=t.target,d=f(e,o);if(!d||d.getAttribute("data-for-oembed-active")==="1")return;t.preventDefault(),t.stopPropagation();let l=d.getAttribute("data-for-oembed-url")||"";y(e,l,u=>E(e,d,u))}),e.addCommand("forOembedInsert",()=>{let t=f(e);if(t){let o=t.getAttribute("data-for-oembed-url")||"";y(e,o,d=>E(e,t,d))}else y(e,"",o=>$(e,o))}),e.addCommand("forOembedEdit",()=>{let t=f(e);if(!t)return;let o=t.getAttribute("data-for-oembed-url")||"";y(e,o,d=>E(e,t,d))}),e.ui.registry.addIcon("for-oembed",'<svg width="24" height="24" viewBox="0 0 24 24"><rect x="2.5" y="5" width="19" height="14" rx="2.5" ry="2.5" fill="none" stroke="currentColor" stroke-width="1.5"/><path d="M10 9.2v5.6l4.8-2.8z" fill="currentColor"/></svg>'),e.ui.registry.addToggleButton("for_oembed",{icon:"for-oembed",tooltip:"Video einbetten (YouTube / Vimeo)",onAction:()=>e.execCommand("forOembedInsert"),onSetup:t=>{let o=()=>t.setActive(!!f(e));return e.on("NodeChange",o),()=>e.off("NodeChange",o)}}),e.ui.registry.addMenuItem("for_oembed",{icon:"for-oembed",text:"Video einbetten (YouTube / Vimeo)",onAction:()=>e.execCommand("forOembedInsert")}),e.ui.registry.addContextToolbar("for_oembed_context",{predicate:t=>{let o=t;return!!(o&&o.nodeType===1&&o.classList&&o.classList.contains("for-oembed"))},items:"for_oembed_width for_oembed_align for_oembed_ratio | for_oembed_preview for_oembed_edit for_oembed_remove",position:"node",scope:"node"});let r=C(e,"oembedwidth_presets",R),i=r.map(t=>t.value).filter(Boolean);e.ui.registry.addMenuButton("for_oembed_width",{icon:"resize",tooltip:"Breite",fetch:t=>{let o=f(e),d=T(o,r);t(r.map(l=>({type:"menuitem",text:l.label+(l.value===d?"  \u2713":""),onAction:()=>{let u=f(e);u&&A(e,u,i,l.value)}})))}});let n=C(e,"oembedalign_presets",D),s=n.map(t=>t.value).filter(Boolean);e.ui.registry.addMenuButton("for_oembed_align",{icon:"align-left",tooltip:"Ausrichtung / Textumlauf",fetch:t=>{let o=f(e),d=T(o,n);t(n.map(l=>({type:"menuitem",text:l.label+(l.value===d?"  \u2713":""),onAction:()=>{let u=f(e);u&&A(e,u,s,l.value)}})))}});let a=C(e,"oembedratio_presets",B),c=a.map(t=>t.value).filter(Boolean);return e.ui.registry.addMenuButton("for_oembed_ratio",{icon:"crop",tooltip:"Seitenverh\xE4ltnis",fetch:t=>{let o=f(e),d=T(o,a);t(a.map(l=>({type:"menuitem",text:l.label+(l.value===d?"  \u2713":""),onAction:()=>{let u=f(e);if(u&&(A(e,u,c,l.value),u.getAttribute("data-for-oembed-active")==="1")){let h=u.querySelector(".for-oembed__ratio iframe");h&&(h.src=h.src)}}})))}}),e.ui.registry.addButton("for_oembed_edit",{icon:"edit-block",tooltip:"URL bearbeiten",onAction:()=>e.execCommand("forOembedEdit")}),e.ui.registry.addButton("for_oembed_preview",{icon:"preview",tooltip:"Video in neuem Tab \xF6ffnen",onAction:()=>{let t=f(e),o=t==null?void 0:t.getAttribute("data-for-oembed-url");o&&window.open(o,"_blank","noopener,noreferrer")}}),e.ui.registry.addButton("for_oembed_remove",{icon:"remove",tooltip:"Video entfernen",onAction:()=>{let t=f(e);t&&(e.undoManager.transact(()=>{var o;(o=t.parentNode)==null||o.removeChild(t)}),e.nodeChanged())}}),{getMetadata:()=>({name:"FriendsOfREDAXO oEmbed",url:"https://github.com/FriendsOfREDAXO/tinymce"})}})},k=q;k();})();
