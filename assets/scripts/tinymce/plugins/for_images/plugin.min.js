(()=>{var z=[{label:"Original",class:""},{label:"Klein (150px)",class:"img-width-small"},{label:"Mittel (300px)",class:"img-width-medium"},{label:"Gro\xDF (600px)",class:"img-width-large"},{label:"100%",class:"img-width-full"}],O=[{label:"Keine",class:""},{label:"Links",class:"img-align-left"},{label:"Rechts",class:"img-align-right"},{label:"Zentriert",class:"img-align-center"}],R=[{label:"Kein Effekt",class:""}];function w(t){if(t.nodeName==="FIGURE")return t;let r=t.parentElement;return r&&r.nodeName==="FIGURE"?r:null}function E(t,r){let c=w(r);if(c)return c;let l=t.getDoc().createElement("figure"),o=r.parentElement;return o&&o.nodeName==="P"?Array.from(o.childNodes).some(e=>e!==r&&(e.nodeType!==Node.TEXT_NODE||(e.textContent||"").trim()!==""))?(o.parentNode.insertBefore(l,o),l.appendChild(r)):(o.parentNode.insertBefore(l,o),l.appendChild(r),o.remove()):o&&(o.insertBefore(l,r),l.appendChild(r)),l}function d(t){let r=t.selection.getNode();if(r.nodeName==="IMG")return r;if(r.nodeName==="FIGURE")return r.querySelector("img");if(r.nodeName==="FIGCAPTION"){let c=r.parentElement;if((c==null?void 0:c.nodeName)==="FIGURE")return c.querySelector("img")}return null}function L(t){let r=[];return t.forEach(c=>{c.class&&c.class.split(/\s+/).forEach(g=>{g&&!r.includes(g)&&r.push(g)})}),r}function A(t,r){L(r).forEach(g=>t.classList.remove(g))}function C(t){let r=[];t.classList.forEach(g=>{(g==="image"||g==="image_resized"||g.indexOf("image-style-")===0||g.indexOf("img-width-")===0||g.indexOf("img-height-")===0)&&r.push(g)}),r.forEach(g=>t.classList.remove(g));let c=t.style.width;c&&c.indexOf("%")!==-1&&(t.style.removeProperty("width"),t.getAttribute("style")===""&&t.removeAttribute("style"))}function B(t){let r=L(t).join(" ");return r.includes("uk-width")?"uk-width-1-1":/\bw-\d/.test(r)?"w-100":""}function H(t,r){t.classList.remove("uk-width-1-1","w-100"),t.style.removeProperty("width"),r?t.classList.add(r):t.style.width="100%"}function p(t,r,c,g){let l=c.class?E(t,r):w(r),o=B(g),m=!!t.options.get("image_compat_warn");l&&(A(l,g),m&&C(l),c.class?(c.class.split(/\s+/).forEach(e=>{e&&l.classList.add(e)}),H(r,o)):o&&(o.split(/\s+/).forEach(e=>{e&&r.classList.remove(e)}),r.classList.length===0&&r.removeAttribute("class")),l.classList.length===0&&l.removeAttribute("class")),r.style.removeProperty("width"),r.style.removeProperty("height"),r.getAttribute("style")===""&&r.removeAttribute("style"),t.nodeChanged(),t.undoManager.add()}function F(t,r,c,g){let l=!!t.options.get("image_compat_warn");if(c.class){let o=E(t,r),m=c.class.split(/\s+/).filter(i=>i);m.every(i=>o.classList.contains(i))?m.forEach(i=>o.classList.remove(i)):m.forEach(i=>o.classList.add(i)),l&&C(o),o.classList.length===0&&o.removeAttribute("class")}else{let o=w(r);o&&(A(o,g),l&&C(o),o.classList.length===0&&o.removeAttribute("class"))}t.nodeChanged(),t.undoManager.add()}function h(t,r){let g=w(t)||t;for(let l of r){if(!l.class)continue;let o=l.class.split(/\s+/).filter(m=>m);if(o.length>0&&o.every(m=>g.classList.contains(m)))return l}return null}function v(t,r){let g=w(t)||t,l=[];for(let o of r){if(!o.class)continue;let m=o.class.split(/\s+/).filter(e=>e);m.length>0&&m.every(e=>g.classList.contains(e))&&l.push(o)}return l}var G=`
  figure {
    margin: 0;
    padding: 0;
    display: table;
...
`,D=(t,r)=>{t.options.register("imagewidth_presets",{processor:"object[]",default:[]}),t.options.register("imagealign_presets",{processor:"object[]",default:[]}),t.options.register("imageeffect_presets",{processor:"object[]",default:[]}),t.options.register("image_compat_warn",{processor:"boolean",default:!1});let c=!1,g=e=>e?!!(e.querySelector("figure.image, figure.image_resized")||e.querySelector('[class*="image-style-"]')):!1,l=()=>{if(c||!t.options.get("image_compat_warn"))return;let e=t.getBody();if(g(e)){c=!0;try{t.notificationManager.open({type:"warning",text:"Hinweis: Dieser Inhalt enth\xE4lt Bildmarkup aus dem alten CKEditor 5 (z. B. figure.image, image-style-\u2026). Bitte die betroffenen Bilder mit der neuen Bildformatierungs-Toolbar (Breite, Ausrichtung, Effekte) erneut formatieren und den Beitrag speichern, damit das Markup einheitlich wird.",closeButton:!0,timeout:12e3})}catch(i){}}};t.ui.registry.addIcon("for_imagedialog",'<svg width="24" height="24" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="12" rx="1.5"/><circle cx="8" cy="8" r="1.4" fill="currentColor" stroke="none"/><path d="M3 13l4-4 3 3 4-5 7 6"/><path d="M3 19h6M15 19h6"/><circle cx="12" cy="19" r="1.8" fill="currentColor" stroke="none"/></g></svg>'),t.ui.registry.addIcon("for_imagealignleft_icon",'<svg width="24" height="24" viewBox="0 0 20 20"><path fill="currentColor" opacity=".55" d="M2 3h16v1.5H2zM2 15h16v1.5H2z"/><rect x="2" y="7" width="10" height="6.5" rx="1" fill="none" stroke="currentColor" stroke-width="1.6"/><path fill="currentColor" d="M14 8h4v1.4h-4zM14 10.6h3.2V12H14zM14 13.2h3.8v1.3H14z"/></svg>'),t.ui.registry.addIcon("for_imagealigncenter_icon",'<svg width="24" height="24" viewBox="0 0 20 20"><path fill="currentColor" opacity=".55" d="M2 3h16v1.5H2zM2 15h16v1.5H2z"/><rect x="5" y="7" width="10" height="6.5" rx="1" fill="none" stroke="currentColor" stroke-width="1.6"/></svg>'),t.ui.registry.addIcon("for_imagealignright_icon",'<svg width="24" height="24" viewBox="0 0 20 20"><path fill="currentColor" opacity=".55" d="M2 3h16v1.5H2zM2 15h16v1.5H2z"/><path fill="currentColor" d="M2 8h4v1.4H2zM2 10.6h3.2V12H2zM2 13.2h3.8v1.3H2z"/><rect x="8" y="7" width="10" height="6.5" rx="1" fill="none" stroke="currentColor" stroke-width="1.6"/></svg>'),t.ui.registry.addIcon("for_imagealignnone_icon",'<svg width="24" height="24" viewBox="0 0 24 24"><rect x="5" y="5" width="14" height="12" rx="1.5" fill="#6b7280"/><circle cx="8.5" cy="9" r="0.9" fill="#ffffff"/><path d="M7.2 14l1.6-2 1.2 1.4 1.3-1.8 1.8 2.4" fill="none" stroke="#ffffff" stroke-width="1.1" stroke-linecap="round" stroke-linejoin="round"/><path d="M5.8 18.2l12.4-12.4" stroke="#6b7280" stroke-width="1.8" stroke-linecap="round"/></svg>');let o=()=>{let e=s=>{var a,f;let n=t.options.get(s);return(!n||Array.isArray(n)&&n.length===0)&&(n=(a=t.settings)==null?void 0:a[s]),(!n||Array.isArray(n)&&n.length===0)&&(n=(f=t.getParam)==null?void 0:f.call(t,s,null)),n},i=(s,n)=>Array.isArray(s)&&s.length>0?s:n;return{widthPresets:i(e("imagewidth_presets"),z),alignPresets:i(e("imagealign_presets"),O),effectPresets:i(e("imageeffect_presets"),R)}};t.on("init",()=>{let e=t.getDoc();if(e){let a=e.createElement("style");a.setAttribute("data-for-images-plugin","1"),a.textContent=G,e.head.appendChild(a)}let i=t.getBody(),s=o(),n=B(s.widthPresets);i.querySelectorAll("figure").forEach(a=>{let f=a,y=f.querySelector("img");y&&f.classList.length>0&&H(y,n)}),l()}),t.on("SetContent",()=>{l()}),t.on("ObjectResizeStart",e=>{e.target&&e.target.nodeName==="IMG"&&e.preventDefault()}),t.options.set("object_resizing",!1);let m=t.options.isRegistered;typeof m=="function"&&m.call(t.options,"quickbars_image_toolbar")&&t.options.set("quickbars_image_toolbar",!1),t.options.set("image_caption",!1),t.ui.registry.addMenuButton("imagewidth",{icon:"resize",tooltip:"Bildbreite",fetch:e=>{let i=d(t);if(!i){e([]);return}let s=o(),n=h(i,s.widthPresets);e(s.widthPresets.map(a=>({type:"menuitem",text:a.label,icon:n&&n.class===a.class?"checkmark":void 0,onAction:()=>p(t,i,a,s.widthPresets)})))}}),t.ui.registry.addToggleButton("for_imagealignleft",{icon:"for_imagealignleft_icon",tooltip:"Bild links",onAction:()=>{let e=d(t);if(!e)return;let i=o(),s=i.alignPresets.find(a=>a.class.includes("float-left")||a.class.includes("float-start")||a.class.includes("align-left")||a.class.includes("uk-float-left")),n=h(e,i.alignPresets);n&&s&&n.class===s.class?p(t,e,{label:"",class:""},i.alignPresets):s&&p(t,e,s,i.alignPresets)},onSetup:e=>{let i=()=>{let s=d(t);if(!s){e.setActive(!1);return}let n=o(),a=h(s,n.alignPresets);e.setActive(!!a&&(a.class.includes("float-left")||a.class.includes("float-start")||a.class.includes("align-left")||a.class.includes("uk-float-left")))};return t.on("NodeChange",i),()=>t.off("NodeChange",i)}}),t.ui.registry.addToggleButton("for_imagealigncenter",{icon:"for_imagealigncenter_icon",tooltip:"Bild zentrieren",onAction:()=>{let e=d(t);if(!e)return;let i=o(),s=i.alignPresets.find(a=>a.class.includes("margin-auto")||a.class.includes("mx-auto")||a.class.includes("align-center")),n=h(e,i.alignPresets);n&&s&&n.class===s.class?p(t,e,{label:"",class:""},i.alignPresets):s&&p(t,e,s,i.alignPresets)},onSetup:e=>{let i=()=>{let s=d(t);if(!s){e.setActive(!1);return}let n=o(),a=h(s,n.alignPresets);e.setActive(!!a&&(a.class.includes("margin-auto")||a.class.includes("mx-auto")||a.class.includes("align-center")))};return t.on("NodeChange",i),()=>t.off("NodeChange",i)}}),t.ui.registry.addToggleButton("for_imagealignright",{icon:"for_imagealignright_icon",tooltip:"Bild rechts",onAction:()=>{let e=d(t);if(!e)return;let i=o(),s=i.alignPresets.find(a=>a.class.includes("float-right")||a.class.includes("float-end")||a.class.includes("align-right")||a.class.includes("uk-float-right")),n=h(e,i.alignPresets);n&&s&&n.class===s.class?p(t,e,{label:"",class:""},i.alignPresets):s&&p(t,e,s,i.alignPresets)},onSetup:e=>{let i=()=>{let s=d(t);if(!s){e.setActive(!1);return}let n=o(),a=h(s,n.alignPresets);e.setActive(!!a&&(a.class.includes("float-right")||a.class.includes("float-end")||a.class.includes("align-right")||a.class.includes("uk-float-right")))};return t.on("NodeChange",i),()=>t.off("NodeChange",i)}}),t.ui.registry.addButton("for_imagealignnone",{icon:"for_imagealignnone_icon",tooltip:"Ausrichtung entfernen",onAction:()=>{let e=d(t);if(!e)return;let i=o();p(t,e,{label:"",class:""},i.alignPresets)}}),t.ui.registry.addMenuButton("imageeffect",{icon:"color-picker",tooltip:"Bild-Effekte",fetch:e=>{let i=d(t);if(!i){e([]);return}let s=o(),n=v(i,s.effectPresets);e(s.effectPresets.map(a=>({type:"togglemenuitem",text:a.label,active:a.class===""?n.length===0:n.some(f=>f.class===a.class),onAction:()=>F(t,i,a,s.effectPresets)})))}}),t.ui.registry.addButton("imagewidthdialog",{icon:"for_imagedialog",tooltip:"Bildformatierung",onAction:()=>{let e=d(t);if(!e){t.notificationManager.open({text:"Bitte zuerst ein Bild ausw\xE4hlen.",type:"warning",timeout:3e3});return}let i=o(),s=h(e,i.widthPresets),n=h(e,i.alignPresets),a=v(e,i.effectPresets),f=i.widthPresets.map(u=>({text:u.label,value:u.class})),y=i.alignPresets.map(u=>({text:u.label,value:u.class})),k=i.effectPresets.filter(u=>u.class).map(u=>({type:"checkbox",name:"effect_"+u.class.replace(/\s+/g,"_"),label:u.label})),M={widthClass:(s==null?void 0:s.class)||"",alignClass:(n==null?void 0:n.class)||""};i.effectPresets.filter(u=>u.class).forEach(u=>{M["effect_"+u.class.replace(/\s+/g,"_")]=a.some(x=>x.class===u.class)});let _=[{type:"selectbox",name:"widthClass",label:"Breite",items:f},{type:"selectbox",name:"alignClass",label:"Ausrichtung",items:y}];k.length>0&&_.push({type:"bar",items:k}),t.windowManager.open({title:"Bildformatierung",size:"normal",body:{type:"panel",items:_},buttons:[{type:"cancel",name:"cancel",text:"Abbrechen"},{type:"submit",name:"save",text:"\xDCbernehmen",primary:!0}],initialData:M,onSubmit:u=>{let x=u.getData(),N=i.widthPresets.find(b=>b.class===x.widthClass)||{label:"",class:""};p(t,e,N,i.widthPresets);let S=i.alignPresets.find(b=>b.class===x.alignClass)||{label:"",class:""};p(t,e,S,i.alignPresets);let P=w(e);P&&(A(P,i.effectPresets),i.effectPresets.filter(b=>b.class).forEach(b=>{x["effect_"+b.class.replace(/\s+/g,"_")]&&b.class.split(/\s+/).forEach(T=>{T&&P.classList.add(T)})})),t.nodeChanged(),t.undoManager.add(),u.close()}})}}),t.ui.registry.addContextToolbar("for_imagestoolbar",{predicate:e=>e.nodeName==="IMG"||e.nodeName==="FIGURE"&&e.querySelector("img"),items:"imagewidth for_imagealignleft for_imagealigncenter for_imagealignright imageeffect for_imagealignnone | imagealt imagecaption",position:"node",scope:"node"}),t.ui.registry.addToggleButton("imagealt",{icon:"accessibility-check",tooltip:"Alt-Text bearbeiten",onAction:()=>{let e=d(t);if(!e)return;let i=e.getAttribute("alt")||"";t.windowManager.open({title:"Alt-Text (Bildbeschreibung)",body:{type:"panel",items:[{type:"input",name:"alttext",label:"Beschreibung f\xFCr Screenreader",placeholder:'z.B. "Rotes Auto vor blauem Himmel"'},{type:"htmlpanel",html:'<p style="color:#666;font-size:12px;margin-top:8px;">Beschreiben Sie den Bildinhalt kurz und pr\xE4gnant f\xFCr Menschen die das Bild nicht sehen k\xF6nnen.</p>'}]},initialData:{alttext:i},buttons:[{type:"cancel",text:"Abbrechen"},{type:"submit",text:"Speichern",primary:!0}],onSubmit:s=>{let n=s.getData();e.setAttribute("alt",n.alttext),t.nodeChanged(),t.undoManager.add(),s.close()}})},onSetup:e=>{let i=()=>{let s=d(t);if(!s){e.setActive(!1);return}let n=s.getAttribute("alt");e.setActive(!!n&&n.trim()!=="")};return t.on("NodeChange",i),i(),()=>t.off("NodeChange",i)}}),t.ui.registry.addToggleButton("imagecaption",{icon:"comment",tooltip:"Bildunterschrift",onAction:()=>{var s;let e=d(t);if(!e)return;let i=w(e);if(i){let n=i.querySelector("figcaption");if(n)(s=n.textContent)!=null&&s.trim()?t.selection.setCursorLocation(n,0):n.remove();else{let f=t.getDoc().createElement("figcaption");f.innerHTML="&nbsp;",i.appendChild(f),t.selection.setCursorLocation(f,0)}}else{let n=E(t,e),f=t.getDoc().createElement("figcaption");f.innerHTML="&nbsp;",n.appendChild(f),t.selection.setCursorLocation(f,0)}t.nodeChanged(),t.undoManager.add()},onSetup:e=>{let i=()=>{let s=d(t);if(!s){e.setActive(!1);return}let n=w(s),a=(n==null?void 0:n.querySelector("figcaption"))!==null;e.setActive(a)};return t.on("NodeChange",i),i(),()=>t.off("NodeChange",i)}}),t.on("NodeChange",()=>{let e=d(t);if(!e)return;let i=o(),s=h(e,i.widthPresets),n=h(e,i.alignPresets),a=v(e,i.effectPresets),f=[];s&&s.class&&f.push(s.label),n&&n.class&&f.push(n.label),a.length>0&&f.push(a.map(k=>k.label).join(", "));let y=w(e)||e;f.length>0?y.setAttribute("title",f.join(" \xB7 ")):y.removeAttribute("title")})},I=()=>{tinymce.PluginManager.add("for_images",D)};I();})();
